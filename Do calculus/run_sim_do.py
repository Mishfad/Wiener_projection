...
y1= np.random.uniform(-1,1,[nfft]) # np.ones([nfft])
# y1[0]=1
y2= y1+1#2*np.ones([nfft])
x1_1=DO_restart_record_data_generation(0,y1,nTrajectories, nfft,B,A,noise_pow)
x1_2=DO_restart_record_data_generation(0,y2,nTrajectories, nfft,B,A,noise_pow)
x2_1=DO_restart_record_data_generation(1,y1,nTrajectories, nfft,B,A,noise_pow)
x2_2=DO_restart_record_data_generation(1,y2,nTrajectories, nfft,B,A,noise_pow)
...
for ind in range(6):
    ...
    ax = fig.add_subplot(gsp[0,indc])
    plot_histogram(x2_1[:,ind,freq_index],bin=20,title='X'+str(ind+1)+'/do(X2=y1)')
    ax = fig.add_subplot(gsp[1,indc])
    plot_histogram(x2_2[:,ind,freq_index],bin=20,title='X'+str(ind+1)+'/do(X2=y2)')

# ax = fig.add_subplot(gsp[0, 1])
# plot_histogram(x2_1[:,0,0],bin=20,title='X1/do(X2=y1)')
# ax = fig.add_subplot(gsp[1, 1])
# plot_histogram(x2_2[:,0,0],bin=20,title='X1/do(X2=y2)')

# ax = fig.add_subplot(gsp[0, 2])
# plot_histogram(x2_1[:,2,0],bin=20,title='X3/do(X2=y1)')
# ax = fig.add_subplot(gsp[1, 2])
# plot_histogram(x2_2[:,2,0],bin=20,title='X3/do(X2=y2)')

# ax = fig.add_subplot(gsp[0, 3])
# plot_histogram(x2_1[:,3,0],bin=20,title='X4/do(X2=y1)')
# ax = fig.add_subplot(gsp[1, 3])
# plot_histogram(x2_2[:,3,0],bin=20,title='X4/do(X2=y2)')

# ax = fig.add_subplot(gsp[0, 4])
# plot_histogram(x2_1[:,4,0],bin=20,title='X5/do(X2=y1)')
# ax = fig.add_subplot(gsp[1, 4])
# plot_histogram(x2_2[:,4,0],bin=20,title='X5/do(X2=y2)')

# ax = fig.add_subplot(gsp[0, 5])
# plot_histogram(x2_1[:,5,0],bin=20,title='X6/do(X2=y1)')
# ax = fig.add_subplot(gsp[1, 5])
# plot_histogram(x2_2[:,5,0],bin=20,title='X6/do(X2=y2)')
...
w01_do_of_x1_1,w01_mag=compute_partial_Wiener_coeffs(x1_1,0,1,[])
w10_do_of_x1_1,w10_mag=compute_partial_Wiener_coeffs(x1_1,1,0,[])
w21_do_of_x1_2,w21_mag=compute_partial_Wiener_coeffs(x1_2,0,1,[])
w12_do_of_x1_2,w12_mag=compute_partial_Wiener_coeffs(x1_2,1,0,[])
...
w23,w23_mag=compute_partial_Wiener_coeffs(x2_1,1,2,[])
